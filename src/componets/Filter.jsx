...
const Filter = ({ setBrands, setPriceRange, setHighAndLow, highAndLow }) => {
        ...
        <>
            ...
            {open &&
                createPortal(
                    ...
                    >
                        <div
                            className="bg-transparent p-6 rounded-lg w-80 h-50% mt-8 shadow-xl flex flex-col"
                            onClick={(e) => e.stopPropagation()}
                        >
                            {/* Top Content */}
                            <div className="flex-1">
                                <h2 className="text-2xl text-white bg-green-500  py-1 rounded  font-semibold mb-4 mt-6 text-center">
                                    Filter Product's
                                </h2>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-white text-bold">
